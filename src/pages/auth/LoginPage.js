    ...
    <div className="min-h-screen flex" data-testid="login-page">
      ...
      <div className="flex-1 flex flex-col relative bg-white">
        ...
        <div className="flex items-center justify-between px-6 py-4 relative z-10">
          <Link to="/" className="inline-flex items-center gap-2.5 group" data-testid="login-brand">
              ...
              {step === 'credentials' ? (
                ...
                <form onSubmit={handleTotpSubmit} className="space-y-4" data-testid="login-totp-form">
                  ...
                  <button
                    ...
                    className="w-full text-xs text-[var(--color-text-tertiary)] hover:text-[var(--color-primary)] flex items-center justify-center gap-2 cursor-pointer"
                  >
