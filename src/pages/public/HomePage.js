...
import { ArrowRight, Shield, Globe, Users, Store, CalendarCheck, TrendingUp, Wallet, Palette, Layers } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <div>
      <SEOHead title="Bookando – Affiliate-Booking Plattform" description="Bookando vereint Terminbuchung mit Affiliate-Marketing – für Dienstleister, die mit Partnern skalieren." />
      <PublicNav />

      {/* HERO – Minimal. Nur Headline + Sub + CTA */}
      <section className="relative min-h-screen flex items-center overflow-hidden"
        style={{ background: 'linear-gradient(160deg, var(--color-primary-dark), var(--color-primary) 40%, var(--color-primary-light))' }}>
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[700px] h-[350px] opacity-[0.08] pointer-events-none"
          style={{ background: 'radial-gradient(ellipse, rgba(196,155,62,0.3), transparent)', filter: 'blur(100px)' }} />
        <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 lg:px-12 py-24 md:py-32">
          <div className="max-w-[800px] mx-auto text-center">
            ...
            <p className="text-base lg:text-lg text-white/50 leading-relaxed max-w-[560px] mx-auto mb-12">{t('hero.subtitle')}</p>
        ...
        <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
          <div className="text-center max-w-[600px] mx-auto mb-16">
            ...
            <h2 className="text-3xl lg:text-5xl font-extrabold tracking-tight leading-tight"
              style={{ fontFamily: 'var(--font-heading)', color: 'var(--color-primary)' }}>{t('home.section_feature_title')}</h2>
            <p className="text-base mt-4 leading-relaxed" style={{ color: 'var(--color-text-secondary)' }}>{t('home.section_feature_sub')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              const Icon = f.icon;
              return (
                <div key={i} className="p-8 border rounded-xl transition-all duration-300 hover:-translate-y-0.5"
                  style={{ borderColor: 'var(--color-divider)', background: 'var(--color-surface)' }}>
                  <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-5" style={{ background: 'var(--color-accent-muted)' }}>
                    <Icon size={22} style={{ color: 'var(--color-accent)' }} />
                  </div>
                  <h3 className="text-lg font-bold tracking-tight mb-2" style={{ fontFamily: 'var(--font-heading)', color: 'var(--color-primary)' }}>{f.title}</h3>
      ...
      {/* HOW IT WORKS */}
      <section className="py-16 lg:py-24" style={{ background: 'var(--color-surface-sunken)' }}>
        <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
          <div className="text-center max-w-[600px] mx-auto mb-14">
            ...
            <h2 className="text-3xl lg:text-5xl font-extrabold tracking-tight leading-tight"
              style={{ fontFamily: 'var(--font-heading)', color: 'var(--color-primary)' }}>{t('home.section_how_title')}</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              return (
                <div key={i} className="text-center p-8 bg-white rounded-xl border"
                  ...
                  <h3 className="text-lg font-bold tracking-tight mb-2" style={{ fontFamily: 'var(--font-heading)', color: 'var(--color-primary)' }}>{item.title}</h3>
      ...
      {/* STATS */}
      <section className="py-16 lg:py-24" style={{ background: 'var(--color-primary)' }}>
        <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-[1280px] mx-auto px-6 lg:px-12">
          <div className="relative overflow-hidden rounded-xl text-center p-12 lg:p-20"
            ...
            <h2 className="text-3xl lg:text-5xl font-extrabold text-white leading-tight tracking-tight mb-5"
              style={{ fontFamily: 'var(--font-heading)' }}>{t('home.section_cta_title')}</h2>
